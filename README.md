...
# Open Links in Discord

Adds the ability to open links in Discord in popup windows, rather than in the browser.

## Preview

![Open Links in Discord](screenshots/preview-1.png)
![Open Links in Discord](screenshots/preview-2.gif)

## Todo

- [ ] Add option to force Windows or OSX style titlebar inside popup windows
- [ ] Add the ability to change the keybind used for opening links
- [ ] Add option to reverse the functionality--- where it automatically opens links in popup windows unless the keybind is held
- [ ] Fix bug where the titlebar will stop functioning when opening Discord links (i.e. discord.com/app)
